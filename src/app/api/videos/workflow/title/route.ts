  ...
  const TITLE_PROMT = "Bạn hãy trả lời lại người dùng 1 cách ngắn gọn, tối ưu quá cho seo và focus người dùng vào tiêu đề. Hãy trả lời một cách ngắn gọn súc tích và tiếng việt nhé. Tiêu đề chỉ nên trong khoảng từ 5 từ trở xuống"
